...
pINT :: ParseM IntExpr
pINT = pIntExpr pTypedExpr pBOOL pINT pLIST pMAT

pSTR :: ParseM StrExpr
pSTR = pStrExpr pTypedExpr pBOOL pINT pLIST pMAT pSTR

pBOOL :: ParseM BoolExpr
pBOOL = pBoolExpr pTypedExpr pINT pBOOL pLIST pMAT
...
pMAC typ = pTypedMacExpr typ pTypedExpr (pBrackDocE pDOC) pBOOL pINT pLIST pMAT pMAC
