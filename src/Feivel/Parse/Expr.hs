...
pSTR :: ParseM StrExpr
pSTR = pStrExpr pTypedExpr pBOOL pINT pLIST pSTR
...
pPOLY typ = pTypedPolyExpr typ pTypedConst pTypedExpr pBOOL pINT pPOLY
...
pTypedExpr XX = choice
  ...
  , fmap PolyE (pPolyExpr pTypedConst pTypedExpr pBOOL pINT pPOLY)
  ]
